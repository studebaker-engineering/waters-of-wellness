...
export const WhySection = () => (
	<section className="mb-10">
		...
		<div className="mt-2 flex flex-col-reverse gap-6 lg:flex-row lg:items-center">
			...
			<div className="w-full lg:w-1/2 flex flex-col gap-3 justify-center lg:-ml-12">
				<FactCard
					title="Ancient roots"
					tailwindBgColorClass="bg-tidewater-100"
					className="w-4/5 self-start relative z-10 lg:w-3/4"
				>
					Colonics have been documented as far back as 1500 BCE amongst Egyptian
					physicians, throughout ancient Rome and all the way to modern times
					under modern medical practice.
				</FactCard>
				<FactCard
				...
				>
					Hippocrates recommended enemas regularly, Avicenna praised them across
					the Arab world, and Ayurvedic surgeons in India were describing rectal
					instruments as early as the 6th century BCE.
				</FactCard>
				<FactCard
